#
#  Be sure to run `pod spec lint TrailerVoteSDK.podspec' to ensure this is a
...
#  s.platform     = :ios
  ...
  s.source = { :http => "https://github.com/TrailerVote/TrailerVoteSDK-CocoaPod/archive/1.1.0.zip" }
